...
public class MainActivity extends CustomActivity
{
    ...
    public LeftNavAdapter leftAdapter;
    ...
    private void setActionBarTitle()
    {
        if (this.drawerLayout.isDrawerOpen(this.drawerLeft)) {
            ...
            //getActionBar().setBackgroundDrawable(R.color.left_nav_back_color);
    ...
    private void launchFragment(int paramInt)
    {
        ...
        switch (paramInt)
        {
            case 0: str = "Home";           localObject = new Home();       break;
            ...
            case 5: str = "Contact List";   localObject = new Eobr();       break;
