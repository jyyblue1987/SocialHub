...
public class Globals {
    ...
    public void setVehicleList(ArrayList<VehicleData> data){
        ...
        int cnt = sel_vehicleList.size();
        vehicle_id = new String[cnt];
        vehicle_name = new String[cnt];
        for (int i = 0 ; i < cnt ; i++) {
            vehicle_id[i] = sel_vehicleList.get(i).getVehicleId();
            vehicle_name[i] = sel_vehicleList.get(i).getVehicleName();
        }
    }
